...
Register_Controller()
{
    ...
    LogVerbose ".... request:"
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: application/json\" -H \"Content-Type: application/json\" -d ${request_body} ${joc_url}/joc/api/controller/register"
...
Unregister_Controller()
{
    ...
    LogVerbose ".... request:"
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: application/json\" -H \"Content-Type: application/json\" -d ${request_body} ${joc_url}/joc/api/controller/unregister"
...
Export_Agent()
{
    ...
    LogVerbose ".... request:"
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: */*\" -H \"Content-Type: application/json\" -H \"Accept-Encoding: gzip, deflate\" -d ${request_body} -o ${file} ${joc_url}/joc/api/agents/export"
...
Import_Agent()
{
    ...
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: */*\" ${import_options[*]} ${joc_url}/joc/api/agents/import"
...
Store_Standalone_Agent()
{
    ...
    LogVerbose ".... request:"
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: application/json\" -H \"Content-Type: application/json\" -d ${request_body} ${joc_url}/joc/api/agents/inventory/store"
...
Store_Cluster_Agent()
{
    ...
    LogVerbose ".... request:"
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: application/json\" -H \"Content-Type: application/json\" -d ${request_body} ${joc_url}/joc/api/agents/inventory/cluster/store"
...
Delete_Agent()
{
    ...
    LogVerbose ".... request:"
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: application/json\" -H \"Content-Type: application/json\" -d ${request_body} ${joc_url}/joc/api/agent/delete"
...
Deploy_Standalone_Agent()
{
    ...
    LogVerbose ".... request:"
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: application/json\" -H \"Content-Type: application/json\" -d ${request_body} ${joc_url}/joc/api/agents/inventory/deploy"
...
Deploy_Cluster_Agent()
{
    ...
    LogVerbose ".... request:"
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: application/json\" -H \"Content-Type: application/json\" -d ${request_body} ${joc_url}/joc/api/agents/inventory/cluster/deploy"
...
Revoke_Standalone_Agent()
{
    ...
    LogVerbose ".... request:"
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: application/json\" -H \"Content-Type: application/json\" -d ${request_body} ${joc_url}/joc/api/agents/inventory/revoke"
...
Revoke_Cluster_Agent()
{
    ...
    LogVerbose ".... request:"
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: application/json\" -H \"Content-Type: application/json\" -d ${request_body} ${joc_url}/joc/api/agents/inventory/cluster/revoke"
...
Store_Subagent()
{
    ...
    LogVerbose ".... request:"
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: application/json\" -H \"Content-Type: application/json\" -d ${request_body} ${joc_url}/joc/api/agents/inventory/cluster/subagents/store"
...
Delete_Subagent()
{
    ...
    LogVerbose ".... request:"
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: application/json\" -H \"Content-Type: application/json\" -d ${request_body} ${joc_url}/joc/api/agents/inventory/cluster/subagents/delete"
...
Store_Subagent_Cluster()
{
    ...
    LogVerbose ".... request:"
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: application/json\" -H \"Content-Type: application/json\" -d ${request_body} ${joc_url}/joc/api/agents/cluster/store"
...
Delete_Subagent_Cluster()
{
    ...
    LogVerbose ".... request:"
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: application/json\" -H \"Content-Type: application/json\" -d ${request_body} ${joc_url}/joc/api/agents/cluster/delete"
...
Deploy_Subagent_Cluster()
{
    ...
    LogVerbose ".... request:"
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: application/json\" -H \"Content-Type: application/json\" -d ${request_body} ${joc_url}/joc/api/agents/cluster/deploy"
...
Revoke_Subagent_Cluster()
{
    ...
    LogVerbose ".... request:"
    LogVerbose "curl ${curl_options[*]} -H \"X-Access-Token: ${access_token}\" -H \"Accept: application/json\" -H \"Content-Type: application/json\" -d ${request_body} ${joc_url}/joc/api/agents/cluster/revoke"
...
Arguments()
{
    ...
    case "$1" in
        register|unregister|check|store-agent|delete-agent|deploy-agent|revoke-agent|export-agent|import-agent|store-subagent|delete-subagent|store-cluster|delete-cluster|deploy-cluster|revoke-cluster) action=$1
                                    ;;
        -h|--help)                  Usage 1
                                    exit
                                    ;;
    ...
    if [ "${action}" = "unregister" ] || [ "${action}" = "store-agent" ] || [ "${action}" = "delete-agent" ] || [ "${action}" = "deploy-agent" ] || [ "${action}" = "revoke-agent" ] || [ "${action}" = "import-agent" ] || [ "${action}" = "store-subagent" ] || [ "${action}" = "delete-subagent" ] || [ "${action}" = "store-cluster" ] || [ "${action}" = "delete-cluster" ] || [ "${action}" = "deploy-cluster" ] || [ "${action}" = "revoke-cluster" ]
    then
        if [ -z "${controller_id}" ]
        then
            Usage 2
    ...
    if [ "${action}" = "store-cluster" ] && [ -n "${priority}" ]
    then
        if [ ! "${priority}" = "first" ] && [ ! "${priority}" = "next" ]
        then
            Usage 2
